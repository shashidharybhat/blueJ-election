class Retail_item
{
    ...
    String mastercode ;
    int totalamt;
   public Retail_item(String Itemnum,int qty)   
    { 
      i1 = 2;
      i2 = 4; 
      i3 = 8; 
    ...
    public Retail_item(){
        Retail_list me = new Retail_list();
      me.display();
    }
     public Retail_item(String master,int ite1,int ite2,int ite3,int ite4,int ite5,int ite6,
    ...
    public void it1(){
        System.err.println("you have chosen : book");
